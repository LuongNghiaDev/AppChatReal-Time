...
import com.example.duan.adapters.ChatAdapter;
import com.example.duan.databinding.ActivityChatBinding;
import com.example.duan.models.ChatMessage;
import com.example.duan.models.User;
import com.example.duan.network.ApiClient;
import com.example.duan.network.ApiService;
...
public class ChatActivity extends BaseActivity {
                ...
                if(response.isSuccessful()) {
                    try {
                        if (response.body() != null) {
                            JSONObject responsiveJson = new JSONObject(response.body());
                            JSONArray results = responsiveJson.getJSONArray("results");
                            if(responsiveJson.getInt("failure") == 1) {
    ...
    private void setListenes() {
        ...
        binding.layoutSend.setOnClickListener(b -> sendMessage());
    }
    ...
    private void updateConversion(String message) {
        DocumentReference documentReference =
                database.collection(Constants.KEY_COLLECTION_CONVERSTATIONS).document(conversionId);
